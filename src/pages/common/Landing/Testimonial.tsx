...
export default function Testimonial() {
  return (
    <div className="max-w-7xl mx-auto py-12 bg-primary rounded-2xl mb-12 lg:mb-20">
      <div className="px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mt-8">
          <a
            ...
            className="text-md text-primary rounded-xl bg-white w-[180px] h-[60px] inline-flex items-center justify-center"
          >
            Contact Us
          </a>
        </div>
