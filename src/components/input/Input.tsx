    ...
    <>
      ...
      <div className="mt-2">
        <input
          ...
          onKeyDown={onKeyDown}
          className={
            "mt-2 block pl-3 pr-10 w-full text-base focus:ring-1 focus:ring-primary focus:border-primary focus:outline-none sm:text-lg h-[50px] px-4 py-2 mb-4 border border-gray-300 rounded-[20px] " +
            className
          }
